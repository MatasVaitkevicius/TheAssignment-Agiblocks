    ...
    render() {
        return (
            < div >
                ...
                <input type="file" className="btn btn-outline-secondary" accept=".csv" onChange={(e) => this.setState({ file: e.nativeEvent.target.files[0] })} />
                {this.state.file && (
                    <div>
                        <br />
                        <h6>2.Press button Upload to upload your csv file</h6>
                        <button className="btn btn-success" onClick={() => this.onSubmitClick()}>Upload</button>
                        <br />
                        <br />
